...
//  DatingApp
//
//  Created by Dzmitry Zhuk on 05/08/2019.
...
class RegisterViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextViewDelegate,UITextFieldDelegate,CLLocationManagerDelegate,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if (backButtonFlag == true){
            ...
            if (imagePick == true){
                ...
                self.ageTxtField.isUserInteractionEnabled = false
                ...
                self.maleSekkingBtn.isUserInteractionEnabled = false
                self.femaleSekkingBtn.isUserInteractionEnabled = false
                self.heightTxtField.isUserInteractionEnabled = false
                self.weightTxtField.isUserInteractionEnabled = false
                self.skinTxtField.isUserInteractionEnabled = false
                self.eyesTxtField.isUserInteractionEnabled = false
                self.childrenYesBtn.isUserInteractionEnabled = false
                self.childrenNoBtn.isUserInteractionEnabled = false
                self.howMany.isUserInteractionEnabled = false
                self.skinTxtField.isUserInteractionEnabled = false
                self.religionTxtField.isUserInteractionEnabled = false
                self.aboutUsTextView.isUserInteractionEnabled = false
        ...
        religionTxtField.setColorBottomBorder()
            ...
            self.cameraImageView.isHidden = true
            self.editBtn.isHidden = false
            self.submitBtn.setTitle("Saved", for: .normal)
        ...
        ApIManager.sharedInstance.getCountryState(auth_key: Authorization_key) { (values, error, success) in
            ...
            if (success){
                if (values.count > 0){
                    ...
                    if (self.hideLinesFlag == true || self.imagePick == false){
    ...
    @IBAction func submitBtnPressed(_ sender: Any) {
        ...
        if (profileImgView == nil){
            ...
            Utilities.alertView(controller: self, title: "Enter Height", msg: "Please enter height.")
        }
        else if (weightTxtField.text == ""){
            Utilities.alertView(controller: self, title: "Enter Weight", msg: "Please enter weight.")
        }
        else if (skinTxtField.text == ""){
            Utilities.alertView(controller: self, title: "Enter Skin Color", msg: "Please enter skin color.")
        }
        else if (eyesTxtField.text == ""){
            Utilities.alertView(controller: self, title: "Enter Eyes Color", msg: "Please enter eye color.")
        }
        else if (childrenVal == "0"){
            Utilities.alertView(controller: self, title: "Select Children Status", msg: "Please select children status.")
        }
        ...
        else if (religionTxtField.text == ""){
            Utilities.alertView(controller: self, title: "Enter Religion", msg: "Please enter religion.")
        }
        else if (aboutUsTextView.text == ""){
            Utilities.alertView(controller: self, title: "Enter About Us", msg: "Please enter about us.")
        }
    ...
    @IBAction func editUserInfoBtnPressed(_ sender: Any) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "RegisterEditViewController") as! RegisterEditViewController
...
//    }
    ...
    func goNext(){
       ...
       // self.navigationController?.pushViewController(nextViewController, animated: true)
            ...
            nextViewController.hideLinesFlag = true
            self.navigationController?.pushViewController(nextViewController, animated: true)
        }
    }
